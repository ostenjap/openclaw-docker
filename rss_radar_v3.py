...
def fetch_rss(query_url, max_age_hours=168): # Increased to 168 hours (7 days)
    ...
    try:
        ...
        for entry in root.findall('atom:entry', ns):
            ...
            # Filter: Reject base subreddits (the script already does this for stability)
